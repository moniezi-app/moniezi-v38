# MONIEZI Pro Finance v38.0.1 — Usability Release
...
- Displayed application/report version: **38.0.1**.
...
- License Worker package/source marker updated to **38.0.1** while retaining the stable Worker service name.
- GitHub Pages app URL in the Worker configuration updated to `/moniezi-v38/`.

## Android version-identification update

- Full PWA manifest name: **MONIEZI v38.0.1**.
- Android launcher short name: **MONIEZI 38**.
- Browser title: **MONIEZI v38.0.1**.
...
## v38.0.1 licensing deployment fix

- Added the deployed MONIEZI Cloudflare license Worker as a built-in frontend fallback.
- `VITE_LICENSE_API_BASE` remains supported as an optional GitHub/Vite override, but a missing repository variable no longer prevents license activation.
- No bookkeeping data, receipts, or v38 storage namespaces are changed by this maintenance release.
